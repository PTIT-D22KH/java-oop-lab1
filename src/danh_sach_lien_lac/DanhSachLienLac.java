...
//        Scanner input = new Scanner(new File("src/file_container/danh_sach_lien_lac/DANHSACH.in"));
        ...
        for (int i = 0; i < a.size(); i += 5) {
            students.add(new Student(a.get(i), a.get(i + 1), a.get(i + 2), a.get(i + 3), a.get(i + 4)));
        }
